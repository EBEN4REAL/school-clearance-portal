<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $hd_action = $_POST['hd_action'];
      $pdc_action = $_POST['pdc_action'];
      $scc_action = $_POST['scc_action'];


      $kickoffid = $getStudentProfile['kickoffid'];
      $reg_no = $_GET['matno'];

      $save_record = $general->addHealthCenterRecords($hd, $pdc, $scc, $_SESSION['deptid'], $kickoffid , $reg_no, $hd_action, $pdc_action, $scc_action );
     ...
     // Get student profile
     if(isset($_GET['matno'])){
      $studentProfile = $general->getHealthStatus($_GET['matno']);
                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                          <td>
                            <div class="form-group">
                                <label for="">Hall Damages</label>
                                <input type="text" value="<?php echo $_SESSION['hd_comment']; ?>" name="hd" class="form-control" width="70%" placeholder="">
                            </div>
                          </td>
                          <td>
                          <div class="form-group" style="margin-top: 22px">
                            <select class="form-control" name="hd_action">
                        ...
                        <tr>
                          <td>
                            <div class="form-group">
                                <label for="">Pending Disciplinary case</label>
                                <input type="text" value="<?php echo $_SESSION['pdc_comment']; ?>" name="pdc" class="form-control" placeholder="">
                            </div>
                          </td>
                          <td>
                          <div class="form-group">
                            <label for="">Select action</label>
                            <select class="form-control" name="pdc_action">
                              <option value="1">Clear</option>
                              <option value="0">Unclear</option>
                            </select>
                          </div>
                          ...
                          <td>
                            <div style="margin-top: 22px" class="text-center">
                              <?php   
                                  echo $_SESSION["pdc_status"] == '0' ?
                                  '<span class="badge badge-success badge-pill" style="background: red; font-size: 18px">Not cleared</span>' 
                                  :null;
                              ?>
                              <?php   
                                  echo $_SESSION['pdc_status'] == '1' ?
                                  '<span class="badge badge-success badge-pill" style="background: green; font-size: 18px"> cleared</span>' 
                                  :null;
                              ?>
                            </div>
                        ...
                        <tr>
                          <td>
                            <div class="form-group">
                                <label for="">Sport Center Clearance</label>
                                <input type="text" value="<?php echo $_SESSION['scc_comment']; ?>" name="scc" class="form-control" placeholder="">
                            </div>
                          </td>
                          <td>
                          <div class="form-group">
                            <label for="">Select action</label>
                            <select class="form-control" name="scc_action">
                              <option value="1">Clear</option>
                              <option value="0">Unclear</option>
                            </select>
                          </div>
                          ...
                          <td>
                            <div style="margin-top: 22px" class="text-center">
                              <?php   
                                  echo $_SESSION['scc_status'] == '0' ?
                                  '<span class="badge badge-success badge-pill" style="background: red; font-size: 18px">Not cleared</span>' 
                                  :null;
                              ?>
                              <?php   
                                  echo $_SESSION['scc_status'] == '1' ?
                                  '<span class="badge badge-success badge-pill" style="background: green; font-size: 18px"> cleared</span>' 
                                  :null;
                              ?>
                            </div>
