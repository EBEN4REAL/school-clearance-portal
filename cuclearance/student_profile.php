<?php
    ...
    if(isset($_POST['submit'])){
        $clearance_reason = $_POST['clearance_reason'];
        $semester_id = $_POST['semester_id'];

        $save_record = $general->saveStudentClearanceRecords($_GET['matno'], $clearance_reason, $semester_id);
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <label>Select reason for  this student's clearance </label>
                    <select class="form-control" name="clearance_reason">
                        <option value="Advice to withdraw – Academics">Advice to withdraw – Academics</option>
                        <option value="Advice to withdraw – Disciplinary">Advice to withdraw – Disciplinary</option>
