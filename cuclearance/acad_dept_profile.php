<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $aca_req_action = $_POST['aca_req_action'];
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                          ...
                          <div class="form-group">
                              <label for="">Academic Requirement</label>
                              <input type="text" name="acad_req" class="form-control" width="70%" placeholder="" value="<?php echo $_SESSION['acad_req_comment']; ?>">
                          </div>
                          </td>
                          <td>
                          <div class="form-group" style="margin-top: 22px">
                            <select class="form-control" name="aca_req_action">
