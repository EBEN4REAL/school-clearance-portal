<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $bills_for_damaged_resources = $_POST['bills_for_damaged_resources'];
      $books_outstanding = $_POST['books_outstanding'];

      $bfdr_action = $_POST['bfdr_action'];
      $bo_action = $_POST['bo_action'];

      $kickoffid = $getStudentProfile['kickoffid'];
      $reg_no = $_GET['matno'];

      $save_record = $general->addClrDepartmentRecord($books_outstanding, $bills_for_damaged_resources,  $_SESSION['deptid'], $kickoffid , $reg_no, $bfdr_action, $bo_action);
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                          ...
                          <div class="form-group">
                            <label for="">Books Outstanding</label>
                              <input type="number" name="books_outstanding" class="form-control" width="70%" placeholder="" value="<?php echo $_SESSION['bo_comment']; ?>">
                          </div>
                          </td>
                          <td>
                          <div class="form-group" style="margin-top: 22px">
                            <select class="form-control" name="bo_action">
                        ...
                        <tr>
                          <td>
                          <div class="form-group">
                              <label for=""> Outstanding Bills for damaged resources</label>
                              <input type="number" name="bills_for_damaged_resources" class="form-control" width="70%" placeholder="" value="<?php echo $_SESSION['bfdr_comment']; ?>">
                          </div>
                          </td>
                          <td>
                          <div class="form-group" style="margin-top: 22px">
                            <select class="form-control" name="bfdr_action">
                              <option value="1">Clear</option>
                              <option value="0">Unclear</option>
                            </select>
                          </div>
                          ...
                          <td>
                            <div style="margin-top: 22px" class="text-center">
                              <?php   
                                  echo $_SESSION["bfdr_status"]  == '0' ?
                                  '<span class="badge badge-success badge-pill" style="background: red; font-size: 18px">Not cleared</span>' 
                                  :null;
                              ?>
                              <?php   
                              
                                  echo $_SESSION["bfdr_status"]  == '1' ?
                                  '<span class="badge badge-success badge-pill" style="background: green; font-size: 18px"> cleared</span>' 
                                  :null;
                              ?>
                            </div>
