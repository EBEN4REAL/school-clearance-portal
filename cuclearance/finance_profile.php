...
<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $save_record = $general->addCSISRecords($registration_clearance, $equipment_damage_clearance, $other_service_charges, $Others , $_SESSION['deptid'], $kickoffid , $reg_no);
            ...
            <div class="col-md-6">
                <h3>Financial Department</h3>
                  ...
                  <div class="form-group">
                          ...
                          <input type="number" name="tuition_fees" class="form-control" width="70%" placeholder="">
                      </div>

                      <div class="form-group">
                          <label for="">Make-up Resit/Late Registration charges</label>
                          <input type="number" name="make_up_resit" class="form-control" placeholder="">
                      </div>

                      <div class="form-group">
                          <label for="">CMFB Loan</label>
                          <input type="number" name="cmfb_loan" class="form-control" placeholder="">
                      </div>

                      <div class="form-group">
                          <label for="">Laptop Loan</label>
                          <input type="number" name="laptop_loan" class="form-control" placeholder="">
                      </div>

                      <div class="form-group">
                          <label for="">Staff Guarantee</label>
                          <input type="number" name="staff_guarantee" class="form-control" placeholder="">
                      </div>
                      <div class="form-group">
                          <label for="">Personal Financial Integrity</label>
                          <input type="text" name="personal_financial_integrity" class="form-control" placeholder="">
                      </div>
                      <div class="form-group">
