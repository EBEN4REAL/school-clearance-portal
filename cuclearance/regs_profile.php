<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $academic_record_status = $_POST['ars'];
      $final_school_fees = $_POST['fsf'];

      $ars_action = $_POST['ars_action'];
      $fsf_action = $_POST['fsf_action'];

      $kickoffid = $getStudentProfile['kickoffid'];
      $reg_no = $_GET['matno'];

      $save_record = $general->addRegistryRecords($academic_record_status, $final_school_fees,  $_SESSION['deptid'], $kickoffid , $reg_no, $ars_action, $fsf_action);
     ...
     // Get student profile
     if(isset($_GET['matno'])){
      $studentProfile = $general->getRegistryStudentProfile($_GET['matno']);
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                          ...
                          <div class="form-group">
                            <label for="">Acaemic Record Status</label>
                              <input type="text" name="ars" class="form-control" width="70%" placeholder="" value="<?php echo $_SESSION['ars_comment']; ?>">
                          </div>
                          </td>
                          <td>
                          <div class="form-group" style="margin-top: 22px">
                            <select class="form-control" name="ars_action">
                        ...
                        <tr>
                          <td>
                          <div class="form-group">
                              <label for=""> Final School Fees/Laptop Loan clearance</label>
                              <input type="number" name="fsf" class="form-control" width="70%" placeholder="" value="<?php echo $_SESSION['fsf_comment']; ?>">
                          </div>
                          </td>
                          <td>
                          <div class="form-group" style="margin-top: 22px">
                            <select class="form-control" name="fsf_action">
                              <option value="1">Clear</option>
                              <option value="0">Unclear</option>
                            </select>
                          </div>
                          ...
                          <td>
                            <div style="margin-top: 22px" class="text-center">
                              <?php   
                                  echo $_SESSION["fsf_status"]  == '0' ?
                                  '<span class="badge badge-success badge-pill" style="background: red; font-size: 18px">Not cleared</span>' 
                                  :null;
                              ?>
                              <?php   
                              
                                  echo $_SESSION["fsf_status"]  == '1' ?
                                  '<span class="badge badge-success badge-pill" style="background: green; font-size: 18px"> cleared</span>' 
                                  :null;
                              ?>
                            </div>
