        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">STUDENTS CHANGING WITHIN YOUR DEPARTMENT</h3>
              <span class=" badge badge-success ml-5" style="font-size: 15px"><?php echo $_SESSION['dept']; ?></span>
            </div>
            <div class="box-body">
