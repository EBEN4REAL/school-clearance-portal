...
if(isset($_POST['login'])){
  ...
  $request_id = $getStudentProfile['requestid'];
  $oldlevel =  $getStudentProfile['oldlevel'];
  $newLevel =  $getStudentProfile['newlevel'];
  $semesterid =  $getStudentProfile['semesterid'];
  $oldprogram =  $getStudentProfile['oldprogram'];
  $newprogram =  $getStudentProfile['newprogram'];
  
  

  $save_records = $general->updateStudentRequest($_GET['matno'], $cr, $_SESSION['pc_deptid'], $_SESSION['dept'], $request_id , $oldlevel,$newLevel, $semesterid, $oldprogram, $newprogram);
  if ($save_records) {
          ...
          <div class="box">
            ...
            <div class="col-md-12">
               <form method="POST" class="form_data" >
                ...
                <div class="alert alert-info alert-dismissible">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <h4><i class="icon fa fa-info"></i>Fill the records below as <?php echo $_SESSION['dept']; ?></h4>
                  </div>
                  <div class="form-group">
                      <label for="">Change Remark </label>
                     <input type="text" class="form-control" name="cr"  />
                  </div>

                 
                  <div class="form-group">
                      <button id="submit" class="form-control btn btn-success" name="login" type="submit">Update Request</button>
                  </div>
