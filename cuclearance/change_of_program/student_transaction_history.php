  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li colass="mb-3"><a href="logout.php" class="btn btn-success" style="font-size:16px; color:white">Log out</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <span class=" badge badge-success ml-5" style="font-size: 15px">Logged in as <?php echo $_SESSION['regno']; ?></span>
            </div>
            <div class="box-body">
