...
if(isset($_POST['submit'])){
  ...
  $save_records = $general->effectChangeByRegistrar($_GET['matno'], $getStudentProfile['newlevel'], $getStudentProfile['newprogram']);
  if ($save_records) {
               ...
               <form method="POST" class="form_data" >
                ...
                <div class="alert alert-info alert-dismissible">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" disabled class="form-control" name="" value="<?php echo $getStudentProfile['oldlevel'];  ?>">
                  </div>
                  <div class="form-group">
                      <label for="">New   Level </label>
                     <input type="text" disabled class="form-control" name="nl" value="<?php echo $getStudentProfile['newlevel'];  ?>">
                  </div>
                  <div class="form-group">
                      <label for="">Request   Status </label>
                     <input type="text" disabled class="form-control" name="" value="<?php echo $getStudentProfile['requeststatus'];  ?>">
                  </div>
                  <div class="form-group">
                      <label for="">Old   Program </label>
                     <input type="text" disabled class="form-control" name="" value="<?php echo $getStudentProfile['oldprogram'];  ?>">
                  </div>
                  <div class="form-group">
                      <label for="">New    Program </label>
                     <input type="text" disabled class="form-control" name="np" value="<?php echo $getStudentProfile['newprogram'];  ?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                      <button id="submit" class="form-control btn btn-success" name="submit" type="submit">Effect Change</button>
                  </div>
               </form>
